...
As a college student, claude code bills can ring up pretty fast! Using NVIDIA's developer pack, I am attempting to simulate a multi-agent architecture for coding agents and architected a multi-agent coding harness orchestrating DeepSeek V4 Flash as a planning agent and GLM 5.2 as a code-generation agent over NVIDIA’s free-tier inference endpoints **(Saving me 20 dollars per month!)**.
